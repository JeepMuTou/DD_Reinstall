...
```bash
curl -O https://raw.githubusercontent.com/JeepMuTou/DD_Reinstall/main/reinstall.sh || wget -O ${_##*/} $_
```

国内服务器：

```bash
curl -O https://cnb.cool/JeepMuTou/DD_Reinstall/-/git/raw/main/reinstall.sh || wget -O ${_##*/} $_
```
...
- <https://raw.githubusercontent.com/JeepMuTou/DD_Reinstall/main/reinstall.bat>
...
```batch
certutil -urlcache -f -split https://raw.githubusercontent.com/JeepMuTou/DD_Reinstall/main/reinstall.bat
```
